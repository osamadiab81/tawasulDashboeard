            ...
            value: function (t, e) {
              ...
              "true" === t.node.getAttribute("selected")
                ...
                : (!o.config.states.active.allowMultipleDataPointsSelection &&
                    ...
                    (a = o.globals.dom.Paper.select(".apexcharts-series path")
                      .members),
    ...
    st =
      (n(be, [
        ...
        },
        {
          ...
          value: function () {
            var n = this.w,
              t = n.globals.dom.baseEl.getElementsByClassName(
                "apexcharts-yaxis"
              );
              ...
              0 < d.globals.timescaleLabels.length
                ...
                : ((this.dCtx.lgWidthForSideLegends =
                  ...
                  d.globals.isBarHorizontal &&
                    (n = r = d.globals.yAxisScale[0].result.reduce(function (
                      t,
                      e
                    ) {
                      return t.length > e.length ? t : e;
                  ...
                  ((d.config.xaxis.convertedCatToNumeric && void 0 === r) ||
                    "" === String(r).trim()) &&
                    (n = r = "1"),
                  (l = c = (o = new Y(this.dCtx.ctx)).getTextRects(
                    r,
            ...
            return (
              g.config.yaxis.map(function (t, e) {
                ...
                !f.isYAxisHidden(e) && t.labels.show && c.result.length
                  ? ((void 0 !==
                      (n = r = (i = g.globals.yLabelFormatters[e])(
                        (a =
                    ...
                    (h = l = (o = new Y(d.dCtx.ctx)).getTextRects(
                      r,
